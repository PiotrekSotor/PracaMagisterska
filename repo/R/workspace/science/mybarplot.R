...
mybarplotForScience <- function(matrix, x_lab, y_lab, title, ylim=NULL, offset = 0, legentTitle="Operator mutacji", log="", colors=NULL, colorsForLegend=NULL, legendPosition="topright", legendOutsidePlot=FALSE, insetOfLegend = c(0,0)){
