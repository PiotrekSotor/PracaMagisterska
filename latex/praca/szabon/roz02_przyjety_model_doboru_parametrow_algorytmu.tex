...
\section{Przyjęte parametry algorytmów}
\par
...
Wartość $l_{iter}$ zostanie dobrana na podstawie rezultatów uzyskanych przy wyselekcjonowanych wcześniej pozostałych wartościach parametru. 
