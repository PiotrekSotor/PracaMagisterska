...
\end{itemize}
\par
Jak już wspomniano w podrozdziale \ref{sec:parametry_algorytmow} na tym etapie doboru konfiguracji algorytmu przyjęto $l_{iter}=5$. Ostateczna wartość $l_{iter}$ zostanie dobrana na podstawie szybkości zbieżności uzyskanej dla wyselekcjonowanych pozostałych parametrów.
